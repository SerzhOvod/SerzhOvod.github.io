(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function menuInit() {
            const callBtn = document.getElementById("header__call");
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                    callBtn.classList.toggle("open-close");
                }
            }));
        }
        function menuClose() {
            ...
            document.getElementById("header__call").style.color = "black";
        }
        function showMore() {
        ...
        function headerScroll() {
            ...
            document.addEventListener("windowScroll", (function(e) {
                ...
                if (scrollTop >= startPoint) {
                    ...
                    for (let i = 0; i < link.length; i++) {
                        const element = link[i];
                        element.classList.remove("scroll-link");
                    }
                    for (let i = 0; i < action.length; i++) {
                        const element = action[i];
                        element.classList.remove("scroll-link");
        ...
        links.forEach((link => {
            ...
            } else if ("/concrete.html" === activePage || "/concrete-repair.html" === activePage || "/waterproofing.html" === activePage || "/foundation.html" === activePage || "/underpinning.html" === activePage || "/drain.html" === activePage || "/plumbing.html" === activePage || "/demolition.html" === activePage) links[2].classList.add("active-page"); else if (link.href.includes(`${activePage}`)) link.classList.add("active-page");
        }));
        actions.forEach((action => {
            if ("/" === activePage || "/index.html" === activePage) action.classList.add("_white");
        }));
        "use strict";
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            async function formSend(e) {
                ...
                } else alert("Please, fill in all the required fields correctly!");
            }
        ...
        if (animItems.length > 0) {
            ...
            function animOnScroll(params) {
                for (let index = 0; index < animItems.length; index++) {
                    ...
                    if (pageYOffset > animItemOffset - animItemPoint && pageYOffset < animItemOffset + animItemHeight) animItem.classList.add("_watcher-view"); else animItem.classList.remove("_watcher-view");
                }
            }
            function offset(el) {
                const rect = el.getBoundingClientRect(), scrollTop = (window.pageXOffset || document.documentElement.scrollLeft, 
